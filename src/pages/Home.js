            ...
            <div>
                <nav className="navbar" id="navbar">
                    <div className="nav-home-container" >
                        <a className="home-button" href="/">Portfolio</a>
                    </div>
                    ...
                    <div className="nav-menu" id="nav-menu">
                        <div className="nav-item">
                            <a className="nav-button" id="button-one" href="/#about-me" >About Me</a>
                        </div>
                        <div className="nav-item">
                            <a className="nav-button" id="button-two" href="/#skills" >Skills</a>
                        </div>
                        <div className="nav-item" >
                            <a className="nav-button" id="button-three" href="/#projects" >Projects</a>
                        </div>
                        <div className="nav-item">
